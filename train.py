import sys
sys.path.append('/home/yyang2/data/yyang2/pycharm/char-cnn-text-classification-tensorflow-master')
...
# Misc Parameters
tf.flags.DEFINE_boolean("allow_soft_placement", True, "Allow device soft device placement")#允许动态分配GPU内存
tf.flags.DEFINE_boolean("log_device_placement", False, "Log placement of ops on devices")#打印出设备信息
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        cnn = CNNClassifier(
            sequence_length=x_train.shape[1],#每句话的长度
